  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] bg-background">
      <div className="text-center py-12 px-8 bg-background rounded-2xl border border-border md:py-8 md:px-6 md:mx-4">
        ...
        <Link to="/" className="inline-block py-4 px-8 bg-primary text-white rounded-lg no-underline font-bold transition-all duration-200 hover:bg-[#1B64DA] hover:-translate-y-0.5 hover:text-white">
          홈으로 돌아가기
        </Link>
      </div>
    </div>
